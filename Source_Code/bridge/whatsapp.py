...
def format_invoice_msg_hi(data):
    ...
    for i, it in enumerate(data['items']):
        ...
        # Fix Unit Translations
        unit_en = str(it.get('unit_en') or it.get('unit') or "").strip().upper()
        if unit_en in ["PCS", "NOS", "PIECE", "PIECES"]:
            unit_hi = "नग"
        elif unit_en in ["DOZ", "DOZEN"]:
            unit_hi = "दर्जन"
        elif unit_en in ["BOX", "BOXES"]:
            unit_hi = "बॉक्स"
        elif unit_en in ["KG", "KGS", "KILOGRAM"]:
            unit_hi = "किलो"
        elif unit_en in ["LTR", "LITER", "LITERS", "LITRE"]:
            unit_hi = "लीटर"
        elif unit_en in ["PKT", "PACKET", "PACKETS"]:
            unit_hi = "पैकेट"
        elif unit_en in ["GRM", "GM", "GRAM", "GRAMS"]:
            unit_hi = "ग्राम"
        elif unit_en in ["PATTA", "PATTE"]:
            unit_hi = "पत्ता"
        elif unit_en in ["BTL", "BOTTLE", "BOTTLES"]:
            unit_hi = "बोतल"
        elif unit_en in ["JAR", "JARS"]:
            unit_hi = "जार"
        else:
